...
import SimpleSingularTestimonial, { SimpleSingularTestimonialProps } from './SimpleSingularTestimonial'
...
const Template: StoryFn<SimpleSingularTestimonialProps> = (args: SimpleSingularTestimonialProps) => (
